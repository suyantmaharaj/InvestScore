...
export const SDG_LIST: SDGMeta[] = [
  ...
  { id: 4,  name: 'Quality Education',                       shortName: 'Education',           color: '#C5192D', icon: '📚' },
  ...
  { id: 12, name: 'Responsible Consumption and Production',  shortName: 'Responsible Consump.',color: '#BF8B2E', icon: '♻️' },
...
export const getSDG = (id: number) => SDG_LIST.find(s => s.id === id);
